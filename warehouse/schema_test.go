	...
	testCases := []struct {
	...
	}{
		{
			...
			expect: []WarehouseField{
				...
				{"EventVarErrorKind", "EventVarErrorKind", stringType},
				{"EventVarFields", "EventVarFields", stringType},
				...
				{"EventInteractionToNextPaint", "EventInteractionToNextPaint", int32Type},
				{"EventTimeToInteractive", "EventTimeToInteractive", int32Type},
				{"EventTotalBlockingTime", "EventTotalBlockingTime", int32Type},
				{"EventTimeToFirstByte", "EventTimeToFirstByte", int32Type},
				{"SessionStart", "SessionStart", timeType},
				{"PageName", "PageName", stringType},
				...
				{"PageNumEvents", "PageNumEvents", int32Type},
				{"PageNumDerivedEvents", "PageNumDerivedEvents", int32Type},
